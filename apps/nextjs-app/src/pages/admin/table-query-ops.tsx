...
import { TableQueryOpsPage } from '@/features/app/blocks/admin';
...
const TableQueryOps: NextPageWithLayout = () => <TableQueryOpsPage />;
...
TableQueryOps.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};
export default TableQueryOps;
