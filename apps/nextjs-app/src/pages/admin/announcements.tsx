...
import { AnnouncementsPage } from '@/features/app/blocks/admin';
...
const AnnouncementsAdminPage: NextPageWithLayout = () => <AnnouncementsPage />;
...
AnnouncementsAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
