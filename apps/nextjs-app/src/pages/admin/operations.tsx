...
import { AdminOperationsPage } from '@/features/app/blocks/admin';
...
const Operations: NextPageWithLayout = () => <AdminOperationsPage />;
...
Operations.getLayout = function getLayout(page: ReactElement, pageProps) {
