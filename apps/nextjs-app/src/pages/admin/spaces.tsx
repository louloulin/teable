...
import { AdminSpacesPage } from '@/features/app/blocks/admin';
...
const Spaces: NextPageWithLayout = () => <AdminSpacesPage />;
...
Spaces.getLayout = function getLayout(page: ReactElement, pageProps) {
