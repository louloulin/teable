...
import { AdminUsersPage } from '@/features/app/blocks/admin';
...
const Users: NextPageWithLayout = () => <AdminUsersPage />;
...
Users.getLayout = function getLayout(page: ReactElement, pageProps) {
