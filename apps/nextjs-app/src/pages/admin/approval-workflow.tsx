...
import { ApprovalWorkflowPanel } from '@/features/app/blocks/admin/approval-workflow';
...
const ApprovalWorkflowAdminPage: NextPageWithLayout = () => <ApprovalWorkflowPanel />;
...
ApprovalWorkflowAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default ApprovalWorkflowAdminPage;
