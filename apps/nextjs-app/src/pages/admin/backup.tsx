...
import { BackupPanel } from '@/features/app/blocks/admin/backup';
...
const BackupAdminPage: NextPageWithLayout = () => <BackupPanel />;
...
BackupAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
