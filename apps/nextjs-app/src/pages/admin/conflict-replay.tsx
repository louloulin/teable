...
import { ConflictReplayPanel } from '@/features/app/blocks/admin/conflict-replay';
...
const ConflictReplayAdminPage: NextPageWithLayout = () => <ConflictReplayPanel />;
...
ConflictReplayAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default ConflictReplayAdminPage;
