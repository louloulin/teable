...
import { AdminImportPage } from '@/features/app/blocks/admin/setting/import';
...
const AdminImport: NextPageWithLayout = () => <AdminImportPage />;
...
AdminImport.getLayout = function getLayout(page: ReactElement, pageProps) {
