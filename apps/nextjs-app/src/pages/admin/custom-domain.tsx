...
import { CustomDomainPanel } from '@/features/app/blocks/admin/custom-domain';
...
const CustomDomainAdminPage: NextPageWithLayout = () => <CustomDomainPanel />;
...
CustomDomainAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default CustomDomainAdminPage;
