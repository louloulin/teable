...
import { ViewPermissionPanel } from '@/features/app/blocks/admin/view-permission';
...
const ViewPermissionAdminPage: NextPageWithLayout = () => <ViewPermissionPanel />;
...
ViewPermissionAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default ViewPermissionAdminPage;
