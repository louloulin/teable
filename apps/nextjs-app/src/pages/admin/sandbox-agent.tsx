...
import { SandboxAgentPanel } from '@/features/app/blocks/admin';
...
const SandboxAgentAdminPage: NextPageWithLayout = () => <SandboxAgentPanel />;
...
SandboxAgentAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default SandboxAgentAdminPage;
