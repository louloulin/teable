...
import { AiFieldPanel } from '@/features/app/blocks/admin';
...
const AiField: NextPageWithLayout = () => <AiFieldPanel />;
...
AiField.getLayout = function getLayout(page: ReactElement, pageProps) {
