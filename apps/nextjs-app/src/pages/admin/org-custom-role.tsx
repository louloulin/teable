...
import { OrgCustomRolePanel } from '@/features/app/blocks/admin/org-custom-role';
...
const OrgCustomRoleAdminPage: NextPageWithLayout = () => <OrgCustomRolePanel />;
...
OrgCustomRoleAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default OrgCustomRoleAdminPage;
