...
import { AdminDataDbPage } from '@/features/app/blocks/admin';
...
const DataDbAdminPage: NextPageWithLayout = () => <AdminDataDbPage />;
...
DataDbAdminPage.getLayout = function getLayout(page: ReactElement, pageProps) {
  return <AdminLayout {...pageProps}>{page}</AdminLayout>;
};

export default DataDbAdminPage;
