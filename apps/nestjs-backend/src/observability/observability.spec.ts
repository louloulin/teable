...
import { __getRegistryForTests, __resetMetricsForTests, initMetrics, getMetrics } from './metrics';
import { __getTracingStateForTests, __resetTracingStateForTests, initTracing } from './tracing';
