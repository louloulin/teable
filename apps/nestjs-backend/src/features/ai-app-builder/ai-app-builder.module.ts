...
import { AiAppBuilderRuntimeController, AiAppBuilderPreviewController } from './ai-app-builder-runtime.controller';
...
@Module({
  ...
  controllers: [AiAppBuilderController, AiAppBuilderRuntimeController, AiAppBuilderPreviewController],
